...
export const services = [
  {
    ...
    description:
      'From designing engaging interfaces to developing custom features, my suite covers the entire spectrum of web development, ensuring your digital presence stands out.',
  },
  {
    id: 2,
  ...
  {
    id: 3,
    name: ' Consultation and Support Hub ',
    title: ' Client-Centric Guidance and Collaboration ',
    description:
      ' Navigate the digital landscape confidently with my consultation, training, and collaborative project management services, putting you in control of your online journey. ',
  },
  {
    id: 4,
    name: ' Advertising ',
